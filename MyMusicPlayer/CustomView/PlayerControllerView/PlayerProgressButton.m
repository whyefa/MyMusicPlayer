...
NSString * const PlayerProgressButtonProgressAnimationKey = @"PlayerProgressButtonProgressAnimationKey";

@interface PlayerCircularProgressView : UIView
...
@interface PlayerProgressButton () <UIGestureRecognizerDelegate>

@property (nonatomic, strong) PlayerCircularProgressView *progressView;
@property (nonatomic, assign) int valueLabelProgressPercentDifference;
@property (nonatomic, strong) NSTimer *valueLabelUpdateTimer;

@end

@implementation PlayerProgressButton
...
- (void)sharedSetup {
    self.progressView = [[PlayerCircularProgressView alloc] initWithFrame:self.bounds];
...
- (void)setCentralView:(UIImageView *)centralView {
...
- (void)animateToProgress:(CGFloat)progress {
    ...
    [self.progressView.layer addAnimation:animation forKey:PlayerProgressButtonProgressAnimationKey];
...
- (void)stopAnimation {
    ...
    [self.progressView.layer removeAnimationForKey:PlayerProgressButtonProgressAnimationKey];
...
//        self.progressView.layer.backgroundColor = .CGColor;
...
@implementation PlayerCircularProgressView
